  ...
  render() {
    return (
      <ListView onChangeCb={(cursor) => this.setState({ cursor: cursor })} >
        <TextListItem
          tertiary="For these IconListItems, secondary texts are names and primary texts are some descriptions"
          />
        <TextListItem
        ...
        <IconListItem
          ...
          />
        <IconListItem
          icon={<Avatar src="https://avatars.githubusercontent.com/u/18725968?v=4" online="online" />}
          secondary="Simon Laux"
          primary="This is fake. He has disconnected the connection and is watching ANIME!"
          />
        <IconListItem
          icon={<Avatar src="https://avatars.githubusercontent.com/u/64679557?s=64&v=4" online="unavailable" />}
